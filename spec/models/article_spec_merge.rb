...
describe Article do
  ...
  before do
    ...
    @article1_body="Sun was shining and it was really hot already it was just beginning of April."
    @article2_body="What a year.Hot.Nice."
    @article1_author="Markus"
    @article2_author="Fitzgerald"
    @article1_title="Summer of 83"
    @article2_title="Year of 83"
    @article1=Article.new(:title=>@article1_title, :author=>@article1_author, :body=>@article1_body)
    @comment11=Factory(:comment)
    @comment11.article=@article1
    @comment11.body="comment11 for article1"
    @comment12=Factory(:comment)
    @comment12.article=@article1
    @comment12.body="comment12 for article1"

    @article2=Article.new(:title=>@article2_title, :author=>@article2_author, :body=>@article2_body)
    @comment21=Factory(:comment)
    @comment21.article=@article2
    @comment21.body="comment21 for article2"
    @comment22=Factory(:comment)
    @comment22.article=@article2
    @comment22.body="comment22 for article2"

    @article1.user=@admin
    @article2.user=@nonadmin
  ...
  it "should merge articles content" do
    assert_equal  @article1.body, @article1_body+@article2_body
  end

  it "should take the first title if articles are merged" do
    assert_equal @article1.title, @article1_title
  end

  it "should take the first author if articles are merged" do
    assert_equal @article1.author, @article1_author
  end
